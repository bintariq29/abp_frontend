...
export class BookServiceProxy {
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BookDtoPagedResultDto> {
     ...
     * @return OK
     */
    update(body: UpdateBookDto | undefined): Observable<BookDto> {
...
@Injectable()
export class BookRequestServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    updateRequestStatus(body: UpdateStatusBookRequestDto | undefined): Observable<BookRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/UpdateRequestStatus";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateRequestStatus(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateRequestStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<BookRequestDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookRequestDto>;
        }));
    }

    protected processUpdateRequestStatus(response: HttpResponseBase): Observable<BookRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BookRequestDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    create(body: CreateBookRequestDto | undefined): Observable<BookRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<BookRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: UpdateDaysBookRequestDto | undefined): Observable<BookRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<BookRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BookRequestDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BookRequestDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookRequestDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<BookRequestDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BookRequestDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<BookRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<BookRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return OK
     */
    getRequestsByUserId(userId: number | undefined): Observable<BookRequestDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/BookRequest/GetRequestsByUserId?";
        if (userId === null)
    ...
    protected processGetRequestsByUserId(response: HttpResponseBase): Observable<BookRequestDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class BookRequestDto implements IBookRequestDto {
    id: number;
    userId: number;
    ...
    static fromJS(data: any): BookRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new BookRequestDto();
        result.init(data);
        return result;
    }
...
export class BookRequestDtoPagedResultDto implements IBookRequestDtoPagedResultDto {
    items: BookRequestDto[] | undefined;
    totalCount: number;

    constructor(data?: IBookRequestDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(BookRequestDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): BookRequestDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new BookRequestDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): BookRequestDtoPagedResultDto {
        const json = this.toJSON();
        let result = new BookRequestDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IBookRequestDtoPagedResultDto {
    items: BookRequestDto[] | undefined;
    totalCount: number;
}
...
export class UpdateDaysBookRequestDto implements IUpdateDaysBookRequestDto {
    id: number;
    requestDays: number;
    userId: number;
    bookId: number;

    constructor(data?: IUpdateDaysBookRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateDaysBookRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateDaysBookRequestDto();
        result.init(data);
        return result;
    }
    ...
    clone(): UpdateDaysBookRequestDto {
        const json = this.toJSON();
        let result = new UpdateDaysBookRequestDto();
        result.init(json);
        return result;
...
export interface IUpdateDaysBookRequestDto {
    id: number;
    requestDays: number;
    userId: number;
    bookId: number;
...
export class UpdateStatusBookRequestDto implements IUpdateStatusBookRequestDto {
    id: number;
    status: boolean | undefined;
    userId: number;
    bookId: number;
    ...
    static fromJS(data: any): UpdateStatusBookRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateStatusBookRequestDto();
        result.init(data);
        return result;
    }
    ...
    clone(): UpdateStatusBookRequestDto {
        const json = this.toJSON();
        let result = new UpdateStatusBookRequestDto();
        result.init(json);
        return result;
...
export interface IUpdateStatusBookRequestDto {
    id: number;
    status: boolean | undefined;
    userId: number;
    bookId: number;
